...
$document.ready(function () {
	...
	if (plugins.swiper.length) {
		plugins.swiper.each(function () {
			...
			s.find(".swiper-slide")
				...
				.end()
				.swiper({
					autoplay: ( !isNoviBuilder && s.attr('data-autoplay' ) === "true") ? 5000 : false,
					...
					loop: !isNoviBuilder ? s.attr('data-loop') !== "false" : false,
	...
	if (plugins.owl.length) {
		...
		for (k = 0; k < plugins.owl.length; k++) {
			...
			c.owlCarousel({
				autoplay: !isNoviBuilder ? c.attr("data-autoplay") === "true" : false,
				loop: !isNoviBuilder ? c.attr("data-loop") === "true" : false,
				items: 1,
				autoplaySpeed: 600,
				autoplayTimeout: 3000,
				dotsContainer: c.attr("data-pagination-class") || false,
				navContainer: c.attr("data-navigation-class") || false,
				mouseDrag: !isNoviBuilder ? c.attr("data-mouse-drag") === "true" : false,
